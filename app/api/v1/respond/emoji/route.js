...
export async function POST(req) {
  ...
  const msg = {
    ...
    subject: `${card[0].card_data.recipients[0].name} reacted to your GifGram: ${body.emoji}`,
    text: `${card[0].card_data.recipients[0].name} reacted to your GifGram: ${body.emoji}`,
    html: formatEmojiEmail(
      card[0].card_data.recipients[0].name,
